...
class DiaVoiceAgent:
    ...
    def load_model(self):
        """Load Dia model with proper authentication"""
        ...
        try:
            ...
            if hf_token:
                print("✅ HuggingFace token found and will be used")
                # Try with token using huggingface_hub login
                try:
                ...
                print("⚠️  No HuggingFace token found, trying without authentication...")
                self.model = Dia.from_pretrained("nari-labs/Dia-1.6B")
            ...
            print("   4. Check if you have access to nari-labs/Dia-1.6B")
            raise
...
def main():
    ...
    print("🎯 Dia TTS Real-Time Conversational AI Agent v2.1")
    print("=" * 60)
    ...
    print("✅ Improved HF token handling")
